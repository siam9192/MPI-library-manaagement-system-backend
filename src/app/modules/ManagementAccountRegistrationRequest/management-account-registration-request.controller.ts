    ...
    createRegistrationRequest = catchAsync(async (req, res) => {
     ...
     getRegistrationRequests = catchAsync(async (req, res) => {
      ...
      const paginationOptions = paginationOptionPicker(req.query);
        const result = await managementAccountRegistrationService.getRegistrationRequests(filterPayload,paginationOptions);
        sendSuccessResponse(res, {
      ...
      getRegistrationRequest = catchAsync(async (req, res) => {
          const result = await managementAccountRegistrationService.getRegistrationRequestById(req.params.id)
          sendSuccessResponse(res, {
            message: 'Registration request retrieved  successfully',
            statusCode: httpStatus.OK,
            data: result,
     ...
     cancelRegistrationRequest = catchAsync(async (req, res) => {
        const result = await managementAccountRegistrationService.cancelRegistrationRequest(req.user,req.params.id);
        sendSuccessResponse(res, {
      ...
      rejectRegistrationRequest = catchAsync(async (req, res) => {
        const result = await managementAccountRegistrationService.rejectRegistrationRequest(req.user,req.params.id);
        sendSuccessResponse(res, {
