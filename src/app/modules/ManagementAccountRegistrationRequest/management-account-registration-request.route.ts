...
router.post("/",validateRequest(managementAccountRegistrationRequestValidation.createRegistrationRequest),managementAccountRegistrationRequestController.createRegistrationRequest)
...
router.patch("/:id/cancel",managementAccountRegistrationRequestController.cancelRegistrationRequest)


router.patch("/:id/reject",managementAccountRegistrationRequestController.rejectRegistrationRequest)
